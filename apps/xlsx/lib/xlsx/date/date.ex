defmodule Xlsx.Date.Date do
  ...
  def string_date(date, separator, "DD/MM/YYYY HH:MM") do
    string_number(date.month) <> separator <> string_number(date.day) <> separator <> string_number(date.year) <> " " <> string_number(date.hour) <> ":" <> string_number(date.minute)
  end
