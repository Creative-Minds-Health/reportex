defmodule Xlsx.Ors.Request.List.Report do
  use GenServer
  require Logger

  alias Xlsx.Mongodb.Mongodb, as: Mongodb
  alias Xlsx.Ors.Request.List.Progress, as: Progress
  alias Xlsx.Ors.Request.List.Collector, as: Collector
  alias Xlsx.Ors.Request.List.Worker, as: Worker
