defmodule Xlsx.SrsWeb.Egress.ParserEgress do
  ...
  def age(years, _months, _days, default_value) when years > 120 do
    [default_value, 9]
  end
  def age(years, months, _days, _default_value) when ((years < 1)  and (months >= 1 and months <= 11)) do
    [months, 4]
  end
  def age(_years, months, _days, default_value) when months > 11 do
    [default_value, 9]
  end
  def age(_years, months, days, _default_value) when ((months < 1)  and (days >= 1 and days <= 29) ) do
    [days, 3]
  end
  def age(_years, _months, days, default_value) when days > 29 do
    [default_value, 9]
  end
