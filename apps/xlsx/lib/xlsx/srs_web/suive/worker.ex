defmodule Xlsx.SrsWeb.Suive.Worker do
  ...
  @impl true
  def handle_info({:run, page}, %{"query" => query, "parent" => parent, "collection" => collection, "diagnosis_template" => diagnosis_template, "collector" => collector}=state) do
    ...
    groups = cursor
      ...
      :ok = GenServer.call(collector, {:concat, report, page})
